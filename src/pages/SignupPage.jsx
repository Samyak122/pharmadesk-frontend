    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-100 px-4">
      <div className="w-full max-w-md rounded-[32px] border border-slate-200 bg-white p-8 shadow-xl">
        <div className="mb-6 flex justify-center">
          <img src={resolvePharmacyLogo()} alt="PharmaDesk logo" className="h-16 w-16 rounded-3xl object-cover" />
        </div>
        <h1 className="text-3xl font-semibold text-slate-900">Create your PharmaDesk account</h1>
